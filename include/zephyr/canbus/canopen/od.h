 ...
 * TODO
 */
int canopen_od_get_type_by_handle(struct canopen_od *od, canopen_od_handle_t handle,
				  uint16_t *type);

/**
 * TODO
 */
static inline int canopen_od_get_type(struct canopen_od *od, uint16_t index, uint8_t subindex,
				      uint16_t *type)
{
 ...
 * TODO
 */
int canopen_od_get_bits_by_handle(struct canopen_od *od, canopen_od_handle_t handle, uint8_t *bits);

/**
 * TODO
 */
static inline int canopen_od_get_bits(struct canopen_od *od, uint16_t index, uint8_t subindex,
				      uint8_t *bits)
{
	canopen_od_handle_t handle = canopen_od_find(od, index, subindex);
 ...
 * TODO
 */
int canopen_od_get_size_by_handle(struct canopen_od *od, canopen_od_handle_t handle, size_t *size);

/**
 * TODO
 */
static inline int canopen_od_get_size(struct canopen_od *od, uint16_t index, uint8_t subindex,
				      size_t *size)
{
	canopen_od_handle_t handle = canopen_od_find(od, index, subindex);
 ...
 * TODO
 */
int canopen_od_get_attr_by_handle(struct canopen_od *od, canopen_od_handle_t handle, uint8_t *attr);
