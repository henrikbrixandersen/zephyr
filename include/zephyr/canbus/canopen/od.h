...
struct canopen_od_object {
	...
	/** Object type information for this entry. */
	const uint8_t type;
...
/** @cond INTERNAL_HIDDEN */
#define CANOPEN_OD_OBJECT_INITIALIZER(_index, _type, _entries, _num_entries)                       \
	{                                                                                          \
		.index = _index,                                                                   \
		.type = _type,                                                                     \
		.callback = NULL,                                                                  \
 ...
 * TODO
 */
#define CANOPEN_OD_OBJECT_ENTRIES(_index, _type, _entries...)                                      \
	CANOPEN_OD_OBJECT_INITIALIZER(_index, _type, ((struct canopen_od_entry[]){_entries}),      \
