 ...
 * @file
 * @ingroup canopen_nmt
 * @brief CANopen Network Management (NMT)
 */
...
/**
 * @brief CANopen Network Management (NMT)
 * @defgroup canopen_nmt CANopen Network Management (NMT)
 * @ingroup canopen
 * @{
 */
 ...
 * @retval -EINVAL Node-ID is invalid.
 * @retval -EIO Configuration of the CAN device failed.
 */
