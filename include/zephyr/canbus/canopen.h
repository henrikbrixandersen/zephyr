/*
 * SPDX-FileCopyrightText: Copyright (c) 2021-2026 Henrik Brix Andersen <henrik@brixandersen.dk>
 *
...
/**
 * @file
 * @brief Public API for CANopen (EN 50325-4) (CiA301)
 *
 * CANopen is a communication protocol stack and device profile specification.
 */
 ...
 *
 * @param cob_id CANopen COB-ID.
 * @param filter CAN RX filter.
 */
