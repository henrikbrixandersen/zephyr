...
ZTEST(devicetree_api, test_gpio)
{
	...
	/* DT_GPIO_HOG_CTLR_BY_IDX */
	zassert_true(!strcmp(TO_STRING(DT_GPIO_HOG_CTLR_BY_IDX(TEST_GPIO_HOG_1, 0)),
			     TO_STRING(DT_NODELABEL(test_gpio_1))), "");
	zassert_true(!strcmp(TO_STRING(DT_GPIO_HOG_CTLR_BY_IDX(TEST_GPIO_HOG_1, 1)),
			     TO_STRING(DT_NODELABEL(test_gpio_1))), "");
	zassert_true(!strcmp(TO_STRING(DT_GPIO_HOG_CTLR_BY_IDX(TEST_GPIO_HOG_2, 0)),
			     TO_STRING(DT_NODELABEL(test_gpio_1))), "");
	zassert_true(!strcmp(TO_STRING(DT_GPIO_HOG_CTLR_BY_IDX(TEST_GPIO_HOG_3, 0)),
			     TO_STRING(DT_NODELABEL(test_gpio_2))), "");
